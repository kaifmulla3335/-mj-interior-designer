 ...
 * Centralised here to avoid duplicating the same path data across
 * Contact.jsx, Footer.jsx, and WhatsAppFloat.jsx.
 *
 * Each icon accepts a `size` prop (defaults to 20) so callers can
 * scale it without wrapping in extra markup.
 */
